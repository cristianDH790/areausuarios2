<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="code" value="{{ __('Code : Not Editable') }}" />

            <x-input id="code" type="text" readonly class="mt-1 block w-full text-gray-500"
    ...
    <x-slot name="actions">
        ...
        <x-button wire:loading.attr="disabled" class="px-4 py-2" wire:target="photo">
            {{ __('Save') }}
        </x-button>
    </x-slot>
</x-form-section>
