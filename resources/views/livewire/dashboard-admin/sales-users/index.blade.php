<div>
    ...
    <div class="space-y-8">
        ...
        <div class="bg-white px-4 py-4 card">
            <div class="space-y-4">
                <h2 class="font-semibold">Datos de pago:</h2>
                <div class="flex flex-wrap md:flex-nowrap gap-2 ">

                    <div class="w-full">
                        <x-label>Nombre Banco:</x-label>
                        <x-select class="border-gray-50 w-full py-2" required wire:model="bank_id">
                    ...
                    <div class="w-full">
                        ...
                        <x-input type="text" class="border-gray-50 w-full" required placeholder="Nombre"
                            wire:model="num_transaction" />
                        @error('num_transaction')
                            <span class="text-red-600">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="w-full">
                        <x-label>Fecha Pago</x-label>
                ...
                <div class="flex flex-wrap md:flex-nowrap gap-2 ">
                    <x-textarea class="border-gray-50 w-full" required placeholder="Observaciones"
                ...
                <div class="flex flex-wrap md:flex-nowrap gap-2 ">
                    ...
                    <div class="block w-full">
                        <x-label>Comprobante:</x-label>
                        <x-file.drag-and-drop-single formats="pdf, jpeg, jpg, bmp, png" max_size="25Mb"
                            accept="image/jpeg,image/bmp,image/png" model=photo_voucher>
                            Subir
                            comprobante
