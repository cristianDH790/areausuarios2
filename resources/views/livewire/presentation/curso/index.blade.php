<div class="max-w-7xl mx-auto py-5 px-5 sm:px-6 lg:px-8 space-y-3">
    <br>
    <div class="bg-white shadow-lg rounded-lg py-3 px-2 sm:flex  sm:justify-between items-center w-full align-middle">
        <h1 class="font-bold text-xl uppercase w-full text-gray-600 mb-0">Cursos Disponibles:</h1>
    ...
    @if ($services->isEmpty())
        <div class="bg-white shadow-lg rounded-lg py-20 flex justify-center text-center items-center w-full">
            <h1 class="font-bold text-xl uppercase ">No hay cursos disponibles</h1>
        </div>
    @else
