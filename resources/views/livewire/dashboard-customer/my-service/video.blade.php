    ...
    <div class="bg-white shadow-lg p-4 flex">
        ...
        <div class="w-1/4 p-2 space-y-2">
            <div class="border-2 border-dashed p-2">
                ...
                <p class="font-bold text-base ">Titulo: <span class="text-sm font-normal">Psicologia clinica1</span></p>
                <p class="font-bold text-base ">Descripcion: <span class="text-sm font-normal">Lorem ipsum, dolor sit
                        amet consectetur adipisicing elit. Itaque quas libero earum expedita qui dolore debitis, totam
                        magni temporibus illo cumque amet sunt molestias esse facilis dolorum. Id, excepturi quo.</span>
                </p>
            </div>
            <div class="border-2 border-dashed p-2 space-y-2">
                <h1 class="text-start font-bold text-lg">Siguientes Videos:</h1>
                <x-button class="bg-blue-500 px-4 py-2 hover:bg-blue-700 text-white inline-flex items-center w-full">
                    <i class="fas fa-play mr-2"></i>
                    <span class="">Psicología clínica 2 </span>
                </x-button>
            </div>
        </div>
        ...
        <table class="min-w-full bg-white">
            <thead>
                <tr class="w-full bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                    ...
                    <th class="py-3 px-4 text-left">Materiales de Psicologia clinica</th>
            ...
            <tbody class="text-gray-600 text-sm font-light">
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                    ...
                    <td class="py-3 px-4 text-left"><a href=""
    ...
    <div class="bg-white shadow-lg p-4 ">
        <table class="min-w-full bg-white">
            <thead>
                <tr class="w-full bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                    <th class="py-3 px-4 text-left" style="width: 10px">#</th>
                    <th class="py-3 px-4 text-left">Audio de Psicologia clinica</th>
