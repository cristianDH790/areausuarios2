                            ...
                            @else
                                @foreach ($roles as $rol)
                                    <tr>
                                        ...
                                        <td data-label="Alias">{{ $rol->name }}</td>
                                        ...
                                        <td class="actions-cell">
                                            <div class="buttons right nowrap space-x-1">
                                                ...
                                                <x-button class=" px-1 py-1" href="{{ route('role.edit', $rol->id) }}"
                                                    color="yellow" secondary="800" primary="600" title="view">
                                                    <span class="icon"><i class="mdi mdi-pencil"></i></span>
                                                </x-button>

                                                <x-button class=" --jb-modal px-1 py-1"
                                                    data-target="sample-modal-delete-{{ $rol->id }}" color="red"
                                    ...
                                    <x-modal-table val="-delete-{{ $rol->id }}">
                                        <x-slot name="title">
                                            Borrar rol: {{ $rol->name }}
                                        </x-slot>
